...
{
    {IO_LED3,   GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_UP,     GPIOD, GPIO_Pin_13},
    {IO_LED4,   GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_UP,     GPIOD, GPIO_Pin_12},
    {IO_LED5,   GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_UP,     GPIOD, GPIO_Pin_14},
    {IO_LED6,   GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_UP,     GPIOD, GPIO_Pin_15},
    {IO_KEY0,   GPIO_Mode_IN,  GPIO_OType_OD, GPIO_PuPd_NOPULL, GPIOA, GPIO_Pin_0},
};
/*-----------------------------------------------------------------------------
